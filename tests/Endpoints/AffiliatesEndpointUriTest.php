...
class AffiliatesEndpointUriTest extends TestCase
{
    public function testGetAffiliatesUriQuery(): void
    {
        $history = [];
        ...
        $client->order->affiliates()->get($page, $limit, $name, $partner_id, $sort);
        ...
        $this->assertStringContainsString('partner_id=partner123', $uri);
