...
class ClustersEndpointUriTest extends TestCase
{
    public function testGetClustersUriQuery(): void
    {
        $history = [];
        ...
        $name = 'test';
        $country = 'FI';
        $sort = ['cluster_domain' => SortDirection::Asc, 'name' => SortDirection::Desc];
        $client->swd->clusters()->get($page, $limit, $name, $country, $sort);
        ...
        $this->assertStringContainsString('country=FI', $uri);
        $this->assertStringContainsString('sort=cluster_domain%3Aasc', $uri);
