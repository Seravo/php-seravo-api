...
class PromotionsEndpointUriTest extends TestCase
{
    public function testGetPromotionsUriQuery(): void
    {
        $history = [];
        ...
        $client->order->promotions()->get($page, $limit, $name, $sort);
        ...
        $this->assertStringContainsString('name=promo', $uri);
